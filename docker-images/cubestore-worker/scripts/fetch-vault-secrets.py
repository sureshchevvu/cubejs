...
def main():
    """Main function to fetch all required secrets for Cubestore Worker"""
    logger.info("🔐 Starting vault secrets fetch for Cubestore Worker...")
    ...
    # Set Cubestore Worker specific configuration
    os.environ['CUBESTORE_WORKER_PORT'] = os.environ.get('CUBESTORE_WORKER_PORT', '10001')
    os.environ['CUBESTORE_META_ADDR'] = os.environ.get('CUBESTORE_META_ADDR', 'cubestore-router:9999')
    
    logger.info("🚀 All secrets fetched successfully for Cubestore Worker!")
